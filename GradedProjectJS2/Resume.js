...
function displayResults() {
  if (checkIndex()) {
    ...
    resumeWindow.innerHTML = `
        <div class="resume-head">
            ...
            <div class="details-box">
                ...
                <h3 id="applied-for">Applied For : ${
                  filterList[index].basics.AppliedFor
                }</h3>
            </div>
            <div class="image-box">
                ...
                <div class="side-info">
                    <table class="personal-info" id="personal-info">
                        ...
                        <tbody>
                            ...
                            <tr><td><a href="${
                              filterList[index].basics.profiles.url
                            }">${
      filterList[index].basics.profiles.network
    }</a></td></tr>
                        </tbody>
                    </table>
                    <table class="tech-skills" id="tech-skills">
                        ...
                        <tbody>
                            ${filterList[index].skills.keywords
                              .map((keyword) => `<tr><td>${keyword}</td></tr>`)
                              .join("")}
                        </tbody>
                    </table>
                    <table class="hobbies" id="hobbies">
                        ...
                        <tbody>
                            ${filterList[index].interests.hobbies
                              .map((hobby) => `<tr><td>${hobby}</td></tr>`)
                              .join("")}
                        </tbody>
                    </table>
                    <hr/>
            ...
            <div class="main-section">
                <section class="bio-data experience" id="experience">
                    ...
                    <p><b>Company Name:</b> ${
                      filterList[index].work["Company Name"]
                    }</p>
                    <p><b>Position:</b> ${filterList[index].work.Position}</p>
                    <p><b>Start Date:</b> ${
                      filterList[index].work["Start Date"]
                    }</p>
                    <p><b>End Date:</b> ${
                      filterList[index].work["End Date"]
                    }</p>
                ...
                <section class="bio-data projects" id="projects">
                    <h2>Projects</h2>
                    <p>
                        <b>${filterList[index].projects.name}: </b>${
      filterList[index].projects.description
    }
                    </p>
                </section>
                <section class="bio-data education" id="education">
                    ...
                    <ul>
                        ...
                        <li>
                            <b>PU: </b>
                            ${
                              filterList[index].education["Senior Secondary"]
                                .institute
                            }, 
                            ${
                              filterList[index].education["Senior Secondary"]
                        ...
                        <li>
                            <b>High School: </b>
                            ${
                              filterList[index].education["High School"]
                                .institute
                            }, 
                ...
                <section class="bio-data internship" id="internship">
                    ...
                    <ul>
                        <li><b>Company Name: </b>   ${
                          filterList[index].Internship["Company Name"]
                        }</li>
                        <li><b>Position: </b>       ${
                          filterList[index].Internship.Position
                        }</li>
                        <li><b>Start Date: </b>     ${
                          filterList[index].Internship["Start Date"]
                        }</li>
                        <li><b>End Date: </b>       ${
                          filterList[index].Internship["End Date"]
                        }</li>
                        <li><b>Summary: </b>        ${
                          filterList[index].Internship.Summary
                        }</li>
                    </ul>
                </section>
                <section class="bio-data achievements" id="achievements">
                    <h2>Achievements</h2>
                    <ul>
                        ${filterList[index].achievements.Summary.map(
    ...
    currentResume.innerHTML = `Showing <b>${index + 1}</b> of <b>${
      filterList.length
    }</b>`;
  }
}
